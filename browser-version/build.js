...
var fs = require('fs')
  ...
  , toCopy = ['lib', 'lib-promise', 'lib-extension', 'node_modules']
...
child_process.exec('npm install', { cwd: __dirname }, function (err, stdout, stderr) {
  ...
  // Uglify-es (for ES6 compatible minification!)
  ...
  , function (cb) {
    ...
    var b = browserify({ standalone: 'Nedb' })
      , srcPath = path.join(__dirname, 'src/lib-promise/datastore.js');
